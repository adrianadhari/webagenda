...
<body>
    <div class="">
        ...
        <!-- MAIN -->
        <div class="main">
            @include('include.navbar', ['pageTitle' => 'Reschedule'])
            ...
            <div class="form-container">
                ...
                <form class="p-4" action="{{ route('agenda.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="kegiatan" rows="2" required></textarea>
                    </div>
            ...
            <style>
                ...
                h2 {
                    ...
                    /* Sesuaikan dengan font yang digunakan */
                    font-weight: 700;
                    /* Pastikan tebal */
                    font-size: 24px;
                    /* Sesuaikan dengan desain */
                    color: #333;
                    /* Pastikan warna jelas */
                }
            </style>
        </div>
    </div>
